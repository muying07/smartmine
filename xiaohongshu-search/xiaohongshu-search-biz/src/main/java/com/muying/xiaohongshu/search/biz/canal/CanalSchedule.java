package com.muying.xiaohongshu.search.biz.canal;

import com.alibaba.otter.canal.client.CanalConnector;
import com.alibaba.otter.canal.protocol.CanalEntry;
import com.alibaba.otter.canal.protocol.Message;
import com.google.common.collect.Maps;
import com.muying.xiaohongshu.search.biz.domain.mapper.SelectMapper;
import com.muying.xiaohongshu.search.biz.enums.NoteStatusEnum;
import com.muying.xiaohongshu.search.biz.enums.NoteVisibleEnum;
import com.muying.xiaohongshu.search.biz.enums.StatusEnum;
import com.muying.xiaohongshu.search.biz.index.NoteIndex;
import com.muying.xiaohongshu.search.biz.index.UserIndex;
    ...
    private void handleUserEvent(Map<String, Object> columnMap, CanalEntry.EventType eventType) throws Exception {
        ...
        switch (eventType) {
            ...
            case UPDATE -> { // 记录更新事件
                ...
                if (Objects.equals(status, StatusEnum.ENABLE.getCode())
                        && Objects.equals(isDeleted, 0)) { // 用户状态为已启用，并且未被逻辑删除
                    // 更新用户索引、笔记索引
                    syncNotesIndexAndUserIndex(userId);
                } else if (Objects.equals(status, StatusEnum.DISABLED.getCode()) // 用户状态为禁用
