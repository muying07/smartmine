package com.muying.smartmine.auth.rpc;

import com.muying.framework.common.response.Response;
import com.muying.smartmine.user.api.UserFeignApi;
import com.muying.smartmine.user.dto.req.FindUserByPhoneReqDTO;
import com.muying.smartmine.user.dto.req.RegisterUserReqDTO;
import com.muying.smartmine.user.dto.req.UpdateUserPasswordReqDTO;
