...
import com.muying.xiaohongshu.user.biz.constant.MQConstants;
...
import com.muying.xiaohongshu.user.biz.domain.entity.UserRoleDO;
import com.muying.xiaohongshu.user.biz.domain.mapper.RoleDOMapper;
import com.muying.xiaohongshu.user.biz.domain.mapper.UserDOMapper;
import com.muying.xiaohongshu.user.biz.domain.mapper.UserRoleDOMapper;
import com.muying.xiaohongshu.user.biz.enums.DeletedEnum;
...
import com.muying.xiaohongshu.user.biz.rpc.CountRpcService;
...
public class UserServiceImpl implements UserService {
    ...
    public Response<?> updateUserInfo(UpdateUserInfoReqVO updateUserInfoReqVO) {
        ...
        if (org.apache.commons.lang3.StringUtils.isNotBlank(xiaohashuId)) {
