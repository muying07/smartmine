...
import com.muying.smartmine.comment.biz.model.bo.CommentHeatBO;
import com.muying.smartmine.comment.biz.util.HeatCalculator;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "smartmine_group_" + MQConstants.TOPIC_COMMENT_HEAT_UPDATE, // Group 组
