package com.muying.xiaohongshu.data.align.consumer;

import com.muying.framework.common.util.JsonUtils;
import com.muying.xiaohongshu.data.align.constant.MQConstants;
import com.muying.xiaohongshu.data.align.constant.RedisKeyConstants;
import com.muying.xiaohongshu.data.align.constant.TableConstants;
import com.muying.xiaohongshu.data.align.domain.mapper.InsertMapper;
import com.muying.xiaohongshu.data.align.model.dto.FollowUnfollowMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "xiaohongshu_group_data_align_" + MQConstants.TOPIC_COUNT_FOLLOWING, // Group 组
