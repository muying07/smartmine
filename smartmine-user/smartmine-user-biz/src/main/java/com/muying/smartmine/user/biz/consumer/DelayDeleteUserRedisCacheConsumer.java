package com.muying.smartmine.user.biz.consumer;
...
@Component
@Slf4j
@RocketMQMessageListener(consumerGroup = "smartmine_group_" + MQConstants.TOPIC_DELAY_DELETE_USER_REDIS_CACHE, // Group
