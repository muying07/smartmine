package com.muying.smartmine.user.biz.service.impl;
...
import com.muying.framework.common.util.NumberUtils;
import com.muying.framework.common.util.ParamUtils;
import com.muying.smartmine.count.dto.FindUserCountsByIdRspDTO;
import com.muying.smartmine.user.biz.constant.MQConstants;
import com.muying.smartmine.user.biz.constant.RedisKeyConstants;
import com.muying.smartmine.user.biz.constant.RoleConstants;
import com.muying.smartmine.user.biz.domain.entity.RoleDO;
import com.muying.smartmine.user.biz.domain.entity.UserDO;
import com.muying.smartmine.user.biz.domain.entity.UserRoleDO;
import com.muying.smartmine.user.biz.domain.mapper.RoleDOMapper;
import com.muying.smartmine.user.biz.domain.mapper.UserDOMapper;
import com.muying.smartmine.user.biz.domain.mapper.UserRoleDOMapper;
import com.muying.smartmine.user.biz.enums.DeletedEnum;
import com.muying.smartmine.user.biz.enums.ResponseCodeEnum;
import com.muying.smartmine.user.biz.enums.SexEnum;
import com.muying.smartmine.user.biz.enums.StatusEnum;
...
import com.muying.smartmine.user.biz.rpc.CountRpcService;
import com.muying.smartmine.user.biz.rpc.DistributedIdGeneratorRpcService;
import com.muying.smartmine.user.biz.rpc.OssRpcService;
import com.muying.smartmine.user.biz.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public Response<?> updateUserInfo(UpdateUserInfoReqVO updateUserInfoReqVO) {
        ...
        if (Objects.nonNull(avatarFile)) {
            ...
            if (org.apache.commons.lang3.StringUtils.isBlank(avatar)) {
        ...
        // 小哈书号
        String smartmineId = updateUserInfoReqVO.getsmartmineId();
        if (org.apache.commons.lang3.StringUtils.isNotBlank(smartmineId)) {
            Preconditions.checkArgument(ParamUtils.checksmartmineId(smartmineId), ResponseCodeEnum.smartmine_ID_VALID_FAIL.getErrorMessage());
            userDO.setsmartmineId(smartmineId);
            needUpdate = true;
        }
        ...
        if (org.apache.commons.lang3.StringUtils.isNotBlank(introduction)) {
        ...
        if (Objects.nonNull(backgroundImgFile)) {
            ...
            if (org.apache.commons.lang3.StringUtils.isBlank(backgroundImg)) {
    ...
    public Response<Long> register(RegisterUserReqDTO registerUserReqDTO) {
        ...
        String smartmineId = distributedIdGeneratorRpcService.getsmartmineId();
        ...
        UserDO userDO = UserDO.builder()
                .id(userId)
                .phone(phone)
                .smartmineId(smartmineId) // 自动生成小红书号 ID
                .nickname("小红薯" + smartmineId) // 自动生成昵称, 如：小红薯10000
    ...
    public Response<FindUserByIdRspDTO> findById(FindUserByIdReqDTO findUserByIdReqDTO) {
        ...
        // 若 Redis 缓存中存在该用户信息
        if (org.apache.commons.lang3.StringUtils.isNotBlank(userInfoRedisValue)) {
    ...
    public Response<FindUserProfileRspVO> findUserProfile(FindUserProfileReqVO findUserProfileReqVO) {
        ...
        FindUserProfileRspVO findUserProfileRspVO = FindUserProfileRspVO.builder()
                ...
                .avatar(userDO.getAvatar())
                .nickname(userDO.getNickname())
                .smartmineId(userDO.getsmartmineId())
                .sex(userDO.getSex())
                .introduction(userDO.getIntroduction())
                .build();
