package com.muying.smartmine.user.relation.biz.consumer;
...
import com.muying.smartmine.user.relation.biz.enums.FollowUnfollowTypeEnum;
import com.muying.smartmine.user.relation.biz.model.dto.CountFollowUnfollowMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "smartmine_group_" + MQConstants.TOPIC_FOLLOW_OR_UNFOLLOW, // Group 组
