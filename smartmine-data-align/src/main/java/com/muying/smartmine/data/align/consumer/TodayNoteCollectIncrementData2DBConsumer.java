package com.muying.smartmine.data.align.consumer;

import com.muying.framework.common.util.JsonUtils;
import com.muying.smartmine.data.align.constant.MQConstants;
import com.muying.smartmine.data.align.constant.RedisKeyConstants;
import com.muying.smartmine.data.align.constant.TableConstants;
import com.muying.smartmine.data.align.domain.mapper.InsertMapper;
import com.muying.smartmine.data.align.model.dto.CollectUnCollectNoteMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "smartmine_group_data_align_" + MQConstants.TOPIC_COUNT_NOTE_COLLECT, // Group 组
