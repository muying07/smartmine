...
import com.muying.smartmine.count.biz.enums.LikeUnlikeNoteTypeEnum;
import com.muying.smartmine.count.biz.model.dto.AggregationCountLikeUnlikeNoteMqDTO;
import com.muying.smartmine.count.biz.model.dto.CountLikeUnlikeNoteMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "smartmine_group_" + MQConstants.TOPIC_LIKE_OR_UNLIKE, // Group 组
