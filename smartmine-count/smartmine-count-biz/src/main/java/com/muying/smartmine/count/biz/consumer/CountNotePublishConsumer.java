...
import com.muying.smartmine.count.biz.model.dto.NoteOperateMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "smartmine_group_" + MQConstants.TOPIC_NOTE_OPERATE, // Group 组
