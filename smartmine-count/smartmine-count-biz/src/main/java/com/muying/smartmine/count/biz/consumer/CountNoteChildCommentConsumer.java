...
import com.muying.smartmine.count.biz.enums.CommentLevelEnum;
import com.muying.smartmine.count.biz.model.dto.CountPublishCommentMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "smartmine_group_child_comment_total" + MQConstants.TOPIC_COUNT_NOTE_COMMENT, // Group 组
