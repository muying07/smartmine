...
import com.muying.smartmine.count.biz.enums.LikeUnlikeCommentTypeEnum;
import com.muying.smartmine.count.biz.model.dto.AggregationCountLikeUnlikeCommentMqDTO;
import com.muying.smartmine.count.biz.model.dto.CountLikeUnlikeCommentMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "smartmine_group_count_" + MQConstants.TOPIC_COMMENT_LIKE_OR_UNLIKE, // Group 组
