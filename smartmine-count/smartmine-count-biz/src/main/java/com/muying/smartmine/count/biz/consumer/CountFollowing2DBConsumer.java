...
import com.muying.smartmine.count.biz.enums.FollowUnfollowTypeEnum;
import com.muying.smartmine.count.biz.model.dto.CountFollowUnfollowMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "smartmine_group_" + MQConstants.TOPIC_COUNT_FOLLOWING_2_DB, // Group 组
