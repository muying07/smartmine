...
import com.muying.xiaohongshu.comment.biz.model.bo.CommentHeatBO;
import com.muying.xiaohongshu.comment.biz.util.HeatCalculator;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "xiaohngshu_group_" + MQConstants.TOPIC_COMMENT_HEAT_UPDATE, // Group 组
