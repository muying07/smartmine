package com.muying.smartmine.search.biz.service.impl;
...
public class UserServiceImpl implements UserService {
    ...
    public PageResponse<SearchUserRspVO> searchUser(SearchUserReqVO searchUserReqVO) {
        ...
        // 构建 multi_match 查询，查询 nickname 和 smartmine_id 字段
        sourceBuilder.query(QueryBuilders.multiMatchQuery(
                keyword, UserIndex.FIELD_USER_NICKNAME, UserIndex.FIELD_USER_smartmine_ID));
        ...
        try {
            ...
            for (SearchHit hit : hits) {
                ...
                String smartmineId = (String) sourceAsMap.get(UserIndex.FIELD_USER_smartmine_ID);
